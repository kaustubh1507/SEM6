...
def respond_to_enquiry(enquiry):
    enquiry = enquiry.lower()
    if re.search(r"\b(?:hello|hi)\b", enquiry):
        return random.choice(responses["greeting"])
    elif re.search(r"\b(?:goodbye|bye)\b", enquiry):
        return random.choice(responses["farewell"])
    elif re.search(r"\b(?:help|support)\b", enquiry):
        return random.choice(responses["help"])
    elif re.search(r"\b(?:screen|cracked)\b", enquiry):
        return random.choice(responses["screen_cracked"])
    elif re.search(r"\b(?:battery|charge)\b", enquiry):
        return random.choice(responses["battery_problem"])
    elif re.search(r"\b(?:software|update|reset)\b", enquiry):
        return random.choice(responses["software_issue"])
    elif re.search(r"\b(?:water|damage)\b", enquiry):
        return random.choice(responses["water_damage"])
    else:
        return random.choice(responses["default"])
    
print("welcome to customer service. Type exit to exit")
...
while True:
    ...
    if user_input=="exit":
        break
    bot_response = respond_to_enquiry(user_input)
